...
function save_obdm(file_handler::FileOutputHandler,obdm::AbstractArray{Float64},M::Int64,V::Float64,time_range::Vector{Float64})
        
    obdm_f = get_file(file_handler,"obdm";open_as ="w",replace_list=[V])
